...
const Footer = () => {
  return (
    <footer className="border-t  border-gray-200 py-10 px-6">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 justify-center px-4">
        <div>
          ...
          <form className="flex">
            ...
            <button
              type="submit"
              className="bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all smooth-click-animation "
            >
              Subscribe
            </button>
          </form>
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        <p className="text-gray-500 text-sm tracking-tight text-center">
          &copy; 2026, Atul tech. All right reserved
        </p>
      </div>
    </footer>
  );
